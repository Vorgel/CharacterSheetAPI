...
namespace CharacterSheetAPI.Migrations
{
    ...
    [Migration("20220718004456_removeAppearanceID")]
    partial class removeAppearanceID
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharacterSheetAPI.Models.Ambition", b =>
                {
                    b.Property<int>("AmbitionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AmbitionID"), 1L, 1);
            ...
            modelBuilder.Entity("CharacterSheetAPI.Models.Ambition", b =>
                {
                    b.HasOne("CharacterSheetAPI.Model.Character", null)
                        .WithOne("Ambitions")
                        .HasForeignKey("CharacterSheetAPI.Models.Ambition", "CharacterID")
